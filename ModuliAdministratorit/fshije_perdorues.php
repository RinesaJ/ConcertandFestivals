						...
						<div class="inner">
							<div class="content">
								...
								echo "<tr>";
									...
									echo "<td><a href=\"fshije.php?ID_perdoruesi_umkf=$rreshti[ID_perdoruesi_umkf]\" onClick=\"return confirm('A jeni të sigurt se dëshironi ta fshini përdoruesin?')\" class='button' class='button primary'>Fshijë</a></td>
								</tr>";		
											}
									}
								?>
